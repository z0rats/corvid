...
@router.post(
    ...
    description=(
        "Calculate CVSS 3.1 score from individual base, temporal, and "
        "environmental metrics. Returns the calculated score, severity rating, "
        "and vector string."
    ),
)
...
@router.post(
    ...
    description=(
        "Calculate CVSS 3.1 score from a complete vector string. Parses the "
        "vector and returns calculated scores and severity ratings."
    ),
)
...
@router.post(
    ...
    description=(
        "Validate whether a CVSS 3.1 vector string is properly formatted and "
        "contains valid metric values."
    ),
)
...
@router.post(
    ...
    description=(
        "Calculate CVSS 4.0 score from individual base and threat metrics. "
        "Returns the calculated score, severity rating, and vector string."
    ),
)
...
@router.post(
    ...
    description=(
        "Calculate CVSS 4.0 score from a complete vector string. Parses the "
        "vector and returns calculated scores and severity ratings."
    ),
)
...
@router.post(
    ...
    description=(
        "Validate whether a CVSS 4.0 vector string is properly formatted and "
        "contains valid metric values."
    ),
)
...
@router.get(
    ...
    description=(
        "Retrieve available CVSS 3.1 metrics and their possible values for "
        "building user interfaces or validation."
    ),
)
...
@router.get(
    ...
    description=(
        "Retrieve available CVSS 4.0 metrics and their possible values for "
        "building user interfaces or validation."
    ),
)
