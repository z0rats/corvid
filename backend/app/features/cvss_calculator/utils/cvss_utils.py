...
def build_cvss40_vector_from_metrics(
    base_metrics: dict[str, Any], threat_metrics: dict[str, Any] | None = None
) -> str:
...
def extract_cvss_scores_and_severities(
    cvss_obj: Any,
...
def get_cvss40_metrics_definition() -> dict[str, dict[str, list]]:
    ...
    return {
        ...
        "threat_metrics": {"exploit_maturity": ["X", "U", "P", "A"]},
    }
...
def log_calculation_attempt(
    version: str, calculation_type: str, success: bool, error: str | None = None
) -> None:
