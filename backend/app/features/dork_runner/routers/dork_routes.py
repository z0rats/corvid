...
@router.post(
    ...
    description="Runs a set of parameterized Google/Bing/DuckDuckGo dork templates against a "
    "domain, username, or email, aggregating results into one response",
)
