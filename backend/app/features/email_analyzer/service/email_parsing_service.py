...
from ..schemas.email_schemas import EmailAttachment, EmailBasicInfo, EmailHashes, EmailHop
...
def extract_basic_info(msg: EmailMessage) -> EmailBasicInfo:
    ...
    try:
        ...
        logger.debug(
            "Extracted basic info - From: %s, To: %s",
            basic_info.from_address,
            basic_info.to_address,
        )
        return basic_info
