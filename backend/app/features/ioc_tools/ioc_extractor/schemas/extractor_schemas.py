...
class IOCStatistics(BaseModel):
    ...
    sha256_removed_duplicates: int = Field(
        default=0, description="Number of duplicate SHA256s removed"
    )
    urls_removed_duplicates: int = Field(default=0, description="Number of duplicate URLs removed")
    domains_removed_duplicates: int = Field(
        default=0, description="Number of duplicate domains removed"
    )
    emails_removed_duplicates: int = Field(
