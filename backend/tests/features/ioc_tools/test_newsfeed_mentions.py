...
class TestGetArticlesMentioningIoc:
    ...
    def test_escapes_like_wildcards_in_ioc_value(self, session_factory):
        ...
        _run(
            _seed_article(
                session_factory, link="https://news.example/f", iocs={"emails": ["a_b@example.com"]}
            )
        )
